...
const middleware = require('../node_modules/mongo-express/lib/middleware');
const utils = require('../node_modules/mongo-express/lib/utils');
const updateNotifier = require('update-notifier');
const pkg = require('../node_modules/mongo-express/package.json');
...
try {
    ...
    config = utils.deepmerge(require('../node_modules/mongo-express/config.default'), require('./mongo-express.config'));
} catch (e) {
